 ...
 */
class Admin_AssetsController extends Fizzy_Controller
{
    ...
    public function serveAction()
    {
        ...
        $asset = $this->_getAssetPath($this->_request->getPathInfo(), $namespaces[$namespace]);
    ...
    protected function _getAssetPath($url, $assetType)
    {
        ...
        $assetsPath = rtrim($config->paths->assets, DIRECTORY_SEPARATOR);
